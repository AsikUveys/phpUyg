        ...
        <div class="row">
            <div class="col-12">
                <div class="border p-2 mb-2">
                    <a href="admin-category-create.php" class="btn btn-primary">Kategori Ekle</a>
                </div>
                        ...
                        <?php $sonuc = getCategories(); while($category = mysqli_fetch_assoc($sonuc)):?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="category-edit.php?id=<?php echo $category["id"];?>" class="btn btn-danger btn-sm">Delete</a>
                                </td>
                        <?php endwhile; ?>
                    </tbody>
               </table>
